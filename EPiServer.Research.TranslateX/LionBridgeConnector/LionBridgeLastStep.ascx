<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="LionBridgeLastStep.ascx.cs" Inherits="EPiServer.Research.Connector.Language.LionBridge.WizardLastStep" %>
<div class='divrow'>
