<%@control Language="C#" AutoEventWireup="false" CodeBehind="PageTranslation.ascx.cs" Inherits="EPiServer.Research.Translation.UI.PagePicker" %>
<link href='<%=EPiServer.Configuration.Settings.Instance.SiteUrl+"EPiServer.Research.Translation/Styles/Grid.css" %>' type="text/css" rel='Stylesheet' />
<div class='pluginarea'>
    ...
    <asp:Repeater runat="server" ID='existingProjects'>
        ...
        <ItemTemplate>
            ...
            <td><asp:linkbutton runat=server cssclass='button' OnCommand='delProject' CommandArgument='<%#Eval("pkid") %>' Text="Delete"><span>Delete</span></asp:linkbutton></td>
            </tr>        
        </ItemTemplate>
        <AlternatingItemTemplate>
            ...
            <td><asp:linkbutton ID="Linkbutton1" runat=server cssclass='button' OnCommand='delProject' CommandArgument='<%#Eval("pkid") %>' Text="Delete"><span>Delete</span></asp:linkbutton></td>
            </tr>            
        </AlternatingItemTemplate>
    </asp:Repeater>
    </div>
    ...
    <!--
        var newwinoptions = 'width=550px,height=500px,resizable=1,location=no,scrollbars=1'
        var newwinoptions2 = 'width=520px,height=250px,resizable=1,location=no,scrollbars=0'
        var baseurl = '<%=EPiServer.Configuration.Settings.Instance.SiteUrl+"EPiServer.Research.Translation/UI/" %>';
