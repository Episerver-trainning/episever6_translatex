...
{
    [GuiPlugIn(DisplayName="Translation settings",Area=PlugInArea.SidSettingsArea,Description="Settings for translation service",Url="~/EPiServer.Research.Translation/UI/TranslationUserSettings.ascx")]
