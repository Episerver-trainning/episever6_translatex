<%@ Page Language="C#" AutoEventWireup="false" CodeBehind="EditProject.aspx.cs" Inherits="EPiServer.Research.Translation.UI.EditProject" %>
    ...
    <div class='modalWindow wide'>          
        ...
        <div class='wizard'>
                      ...
                      <asp:WizardStep ID="ProjectSetting" runat="server" Title="Select source language">
                        ...
                        <div class='divrow'>
                            ...
                            <div class='divcolumn'>
                                ...
                                <asp:CheckBoxList runat="server" ID='targetLanguages' RepeatDirection="Horizontal" RepeatColumns="3">
                                </asp:CheckBoxList>
                      ...
                      <asp:WizardStep ID="ProjectPages" runat="server" Title="Modify pages" >                    
                        ...
                        <div class='grid wide500'>
                            ...
                            <asp:repeater runat="server" id="pagesToTranslate">
                                ...
                                <itemtemplate>
                                    <img runat="server" src="~/EPiServer.Research.Translation/Images/blank.gif" width='<%#int.Parse(Eval("Indent")+"0")%>' height="1"/>
                                    <asp:linkbutton ID="Linkbutton1" runat="server" OnCommand='changePageStatus' CommandArgument='<%#Eval("Page_Link") %>'><img src='<%# EPiServer.Configuration.Settings.Instance.SiteUrl + "EPiServer.Research.Translation/images/" + Eval("status") + ".gif"%>' border='0'/></asp:linkbutton>
                                    <%#Eval("Page_Name") %>
                                     <br />
                                </itemtemplate>
                                ...
                                <asp:repeater runat="server" id="filesToTranslate">
                                    ...
                                    <itemtemplate>
                                        ...
                                        <%#Eval("Page_Name") %>
                                         ...
                                         <ItemTemplate>
                                            <img runat="server" src="~/EPiServer.Research.Translation/Images/blank.gif" width='<%#int.Parse(Eval("Indent")+"0")+15%>' height="1"/>
                                            <asp:linkbutton runat="server" OnCommand='changeFileStatus' CommandArgument='<%#Eval("Filepath") %>'><img src='<%# EPiServer.Configuration.Settings.Instance.SiteUrl + "EPiServer.Research.Translation/images/" + Eval("status") + ".gif"%>' border='0'/></asp:linkbutton>
                                            <%#Eval("Filename") %>
                                            <br />
                                        </ItemTemplate>
                                        </asp:Repeater>
            ...
            <StartNavigationTemplate>
                <br />
                <a class='button' onclick='window.close()'><span>Cancel</span></a>                   
        ...
        <asp:Panel runat="server" Visible="false" ID="closeWinPanel">
