...
{
    public partial class ImportPage : SimplePage
    {
        ...
        protected void WizardFinished(object sender, EventArgs e)
        {
            ...
            DataAccess.SaveAction saveAction = publishtype.Value=="0"? DataAccess.SaveAction.Publish:DataAccess.SaveAction.CheckIn;
        ...
        private void createNewPage(string lang, PageReference startNode, int indent, string parentNode, DataAccess.SaveAction saveAction, ref List<TranslationPage> pages, ref TranslationProject tp)
        {
            foreach (TranslationPage page in pages)
            {
