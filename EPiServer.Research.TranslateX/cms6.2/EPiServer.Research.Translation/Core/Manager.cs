...
namespace EPiServer.Research.Translation.Core
{
    ...
    {
        private readonly ILog _log = LogManager.GetLogger((typeof (Manager)));
        ...
        public List<ConnectorDefinition> Connectors
        {
            get
            {
                ...
                { 
                    ...
                    string path = Global.BaseDirectory + "translationconnector.config";
        ...
        {
            string sLanguage = s;
            sLanguage = LanguageManager.Instance.Translate("/translationlanguages/" + sLanguage, "en");
        ...
        public string ToInvalidLocale(string s)
        {
            ICollection<LanguageNode> langs = LanguageManager.Instance.GetLanguage("en")["translationlanguages"].Children;
            foreach (LanguageNode lang in langs)
            {
                if (s == lang.Value)
                {
                    return lang.Name;
        ...
        public void InsertTargetLanguage(int projectid, string language)
        {
            ...
            cmd.Parameters.Add("@targetlanguage", SqlDbType.NVarChar, 10).Value = language;
            cmd.Connection = Connection;
            cmd.ExecuteNonQuery();
            Connection.Close();
        }
        ...
        public DataSet GetRelatedProjects(int CurrentPageID)
        {
            ...
            SqlCommand cmd = new SqlCommand
                {
                    ...
                    CommandText =
                        "select distinct tbltranslationproject.* from tblTranslationProjectItem inner join tblTranslationProject on (tblTranslationproject.workid = tblTranslationProjectItem.workid and (page_link like @pagelinklike or page_link = @pagelink) and indent=1) and isactive=1"
                };
            ...
            {
                _log.Error("Failed getting related projects. " + e.Message);
                Connection.Close();
                return null;
            }
        ...
        public DataSet GetProjects()
        {
            ...
            SqlCommand cmd = new SqlCommand();
            cmd.CommandType = CommandType.Text;
            cmd.CommandText = "select tbltranslationproject.* from tblTranslationProject where isactive=1";
        ...
        public List<TranslationFile> GetProjectFiles(TranslationProject project)
        {
            ...
            using (SqlDataReader sdr = cmd.ExecuteReader())
            {
                ...
                while (sdr.Read())
                {
                    ...
                    file._streamLoader = new TranslationFile.StreamHandler(GetFileStream);
        ...
        public void RemoveProject(int projectID)
        {
            ...
            cmd.Connection = Connection;
            cmd.CommandType = CommandType.Text;
            cmd.CommandText = "update tbltranslationproject set isactive=0 where pkid=@pkid";
            cmd.Parameters.Add("@pkid", SqlDbType.Int).Value = projectID;
            cmd.ExecuteNonQuery();
            Connection.Close();            
        }
    }
