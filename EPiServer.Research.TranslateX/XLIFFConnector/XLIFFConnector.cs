...
{
    public class Connector:EPiServer.Research.Translation4.Common.IConnector
    {
        public Connector()
        {
        }
        ...
        public string SendProject(EPiServer.Research.Translation4.Common.TranslationProject project)
        {
            ...
            string workpath = Path.Combine(tempDir, project.RemoteID);
            string zippath = Path.Combine(tempDir, GetValidFilename(project.Name) + ".translation.zip");
        ...
        public string RetrieveProject(EPiServer.Research.Translation4.Common.TranslationProject project)
        {
            // Get / Create Folder Path for temp storage
        ...
        public void UpdateProject(EPiServer.Research.Translation4.Common.TranslationProject project)
        {
            //throw new NotImplementedException();
        }

        public EPiServer.Research.Translation4.Common.TranslationPage GetPage(byte[] data)
        {
        ...
        public void SetProjectProperty(EPiServer.Research.Translation4.Common.TranslationProject project)
        {
