<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ViewDetails.aspx.cs" Inherits="EPiServer.Research.Translation4.UI.ViewDetails" %>
...
<%@ Register TagPrefix='translation' TagName='styleheader' Src='~/EPiServer.Research.Translation4/UI/StyleHeader.ascx' %>
        ...
        <div class='top'></div>
            ...
            <asp:repeater runat="server" ID='dlPages'>
                <ItemTemplate>
                    <tr>
                    <td>
                    <img id="Img1" runat="server" src="~/EPiServer.Research.Translation4/Images/blank.gif" width='<%#int.Parse(Eval("Indent")+"0")%>' height="1"/>                
                    ...
                    <asp:Repeater ID="Repeater1" runat="server" DataSource='<%#GetPageLanguageStatus((TranslationPage)Container.DataItem )%>'>
                        <ItemTemplate>
                    ...
                    <asp:Repeater ID="Repeater2" runat="server" DataSource='<%# getFileList(((TranslationPage)(Container.DataItem))) %>'>
                        <ItemTemplate>
                            <tr>
                                <td>
                                    <img id="Img2" runat="server" src="~/EPiServer.Research.Translation4/Images/blank.gif" width='<%#int.Parse(Eval("Indent")+"5")%>' height="1"/>
                                    <%# GetFilename(((TranslationFile)Container.DataItem).FilePath)%>
                                </td>
                                <asp:Repeater ID="Repeater3" runat="server" DataSource='<%#GetFileLanguageStatus((TranslationFile)Container.DataItem )%>'>
                                    <ItemTemplate>
                                        <td><%#(string)(Container.DataItem) %></td>
                                    </ItemTemplate>
                                </asp:Repeater>
